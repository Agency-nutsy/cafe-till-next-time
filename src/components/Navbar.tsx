    ...
    >
      <div className="container flex items-center justify-between h-16 md:h-20">
        <Link to="/" className="font-display text-xl md:text-2xl font-bold">
          <span className={showSolid ? "text-primary" : "text-primary-foreground"}>Cafe Till </span>
          <span className={showSolid ? "text-foreground" : "text-primary-foreground/80"}>Next Time</span>
        </Link>
